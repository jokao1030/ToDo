 ...
 * 
 */
public class ToDoR implements Serializable {
	...
	public ToDoR(int id, String item, String description,
	 ...
	 * @param todo
	 */
	public ToDoR updateFrom(ToDoR todo) {
	...
	public boolean equals(Object other) {
		...
		// DataItem
		if (other == null || !(other instanceof ToDoR)) {
			return false;
		} else {
			return ((ToDoR) other).getId() == this.getId();
		}
